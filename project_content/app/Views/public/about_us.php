        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 mb-5 mb-lg-0" data-aos="fade-right">
                    <img src="/public_assets/img/home/nexus.jpg" alt="About Us" class="img-fluid w-100 rounded-3 shadow">
                </div>
                <div class="col-lg-6" data-aos="fade-left">
                    <h2 class="section-title">Our Story</h2>
                    <p>Founded in 2018, KT-NEXUS TECHNOLOGIES began with a simple mission: to deliver high-quality IT solutions that help businesses thrive in the digital age. What started as a small team of passionate developers has grown into a full-service technology company serving clients across multiple industries.</p>
            ...
            <div class="row g-4">
                <div class="col-md-6" data-aos="fade-up">
                    <div class="p-4 bg-white rounded-3 shadow-sm h-100">
                        <div class="icon-box bg-primary bg-opacity-10 text-primary rounded-circle mb-4" style="width: 60px; height: 60px; display: flex; align-items: center; justify-content: center;">
